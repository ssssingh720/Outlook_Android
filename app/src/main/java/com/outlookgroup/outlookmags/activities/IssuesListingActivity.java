...
import com.outlookgroup.outlookmags.Utils.IabHelper;
import com.outlookgroup.outlookmags.Utils.IabResult;
import com.outlookgroup.outlookmags.Utils.Inventory;
import com.outlookgroup.outlookmags.Utils.Purchase;
import com.outlookgroup.outlookmags.Utils.SkuDetails;
import com.outlookgroup.outlookmags.Utils.Util;
import com.outlookgroup.outlookmags.adapters.OutlookGridViewAdapter;
...
import com.outlookgroup.outlookmags.modal.Issue;
import com.outlookgroup.outlookmags.modal.Magazine;
import com.outlookgroup.outlookmags.modal.Month;
import com.outlookgroup.outlookmags.modal.OutlookConstants;
import com.outlookgroup.outlookmags.modal.PurchaseResponseVo;
import com.outlookgroup.outlookmags.modal.YearListVo;
import com.outlookgroup.outlookmags.views.MonthYearPicker;
...
try {
    ...
    private void setGridAdapter(YearListVo yearListVo) {
        ...
        gridView.setAdapter(animationAlphaAdapter);
            ...
            if (!magazineType.equals("5")) {
                // Hiding sub button : make visible for payment
                btnSubscribe.setVisibility(View.GONE);
            }
        }
        else{
    ...
    private ArrayList<Magazine> getMonthList(List<Month> monthArray,String issueYear){
        ...
        for(int i=0; i< monthArray.size();i++){
            ...
            if (magazineType.equals("0") || magazineType.equals("2") ||magazineType.equals("3") ) {
...
//                Log.d("GalleryFragment", "DOWNLOAD Output Path::" + output.toString());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        //== uncomment once payment is open
